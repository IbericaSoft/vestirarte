...
function preloadImages() {
	preloads = new Object();
	preloads[0] = new Image(); preloads[0].src = FORMS_IMAGES + "button_left_xon.gif";
	preloads[1] = new Image(); preloads[1].src = FORMS_IMAGES + "button_right_xon.gif";
	preloads[2] = new Image(); preloads[2].src = FORMS_IMAGES + "input_left_xon.gif";
	preloads[3] = new Image(); preloads[3].src = FORMS_IMAGES + "input_right_xon.gif";
	preloads[4] = new Image(); preloads[4].src = FORMS_IMAGES + "txtarea_bl_xon.gif";
	preloads[5] = new Image(); preloads[5].src = FORMS_IMAGES + "txtarea_br_xon.gif";
	preloads[6] = new Image(); preloads[6].src = FORMS_IMAGES + "txtarea_cntr_xon.gif";
	preloads[7] = new Image(); preloads[7].src = FORMS_IMAGES + "txtarea_l_xon.gif";
	preloads[8] = new Image(); preloads[8].src = FORMS_IMAGES + "txtarea_tl_xon.gif";
	preloads[9] = new Image(); preloads[9].src = FORMS_IMAGES + "txtarea_tr_xon.gif";
}
...
function replaceSelects() {
    for(var q = 0; q < selects.length; q++) {
		...
		//### modifico linea para que coja el width del select que no lo estaba cogiendo
		var selectWidth = parseInt($(selects[q].id).getStyle('width').replace(/px/g,""));
		...
		for(var w = 0; w < selects[q].options.length; w++) {
			...
			//optionLink.onclick = function(){ showOptions(q); selectMe("'"+selects[q].id+"'",w,q); alert('click en '+selects[q].id);};
...
function replaceTexts() {
	for(var q = 0; q < texts.length; q++) {
		...
		txtLeft = document.createElement('img'); txtLeft.src = FORMS_IMAGES + "input_left.gif"; txtLeft.className = "inputCorner";
		txtRight = document.createElement('img'); txtRight.src = FORMS_IMAGES + "input_right.gif"; txtRight.className = "inputCorner";
		...
		texts[q].onfocus = function() {
			...
			this.previousSibling.src = FORMS_IMAGES + "input_left_xon.gif";
			this.nextSibling.src = FORMS_IMAGES + "input_right_xon.gif";
		}
		texts[q].onblur = function() {
			this.className = "textinput";
			this.previousSibling.src = FORMS_IMAGES + "input_left.gif";
			this.nextSibling.src = FORMS_IMAGES + "input_right.gif";
		}
	}
}
function replaceTextareas() {
	for(var q = 0; q < textareas.length; q++) {
		...
		topLeft.src = FORMS_IMAGES + "txtarea_tl.gif";
		...
		bottomLeft.src = FORMS_IMAGES + "txtarea_bl.gif";
		//assemble divs
		...
		textareas[q].onfocus = function() {
			...
			this.parentNode.previousSibling.getElementsByTagName("img")[0].src = FORMS_IMAGES + "txtarea_tl_xon.gif";
			this.parentNode.nextSibling.className = "br_xon";
			this.parentNode.nextSibling.getElementsByTagName("img")[0].src = FORMS_IMAGES + "txtarea_bl_xon.gif";
		}
		textareas[q].onblur = function() {
			...
			this.parentNode.previousSibling.getElementsByTagName("img")[0].src = FORMS_IMAGES + "txtarea_tl.gif";
			this.parentNode.nextSibling.className = "br";
			this.parentNode.nextSibling.getElementsByTagName("img")[0].src = FORMS_IMAGES + "txtarea_bl.gif";
		}
	}
}
function buttonHovers() {
	for (var i = 0; i < buttons.length; i++) {
		...
		buttons[i].onmouseover = function() {
			...
			this.previousSibling.src = FORMS_IMAGES + "button_left_xon.gif";
			this.nextSibling.src = FORMS_IMAGES + "button_right_xon.gif";
		}
		buttons[i].onmouseout = function() {
			this.className = this.className.replace(/Hovered/g, "");
			this.previousSibling.src = FORMS_IMAGES + "button_left.gif";
			this.nextSibling.src = FORMS_IMAGES + "button_right.gif";
		}
	}
}
//Useful functions
