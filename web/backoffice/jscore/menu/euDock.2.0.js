 ...
 */
		function euDock(){
			...
			document.write("<div id='"+this.id+"_bar' style='z-index:0;position:absolute;border:0px solid black;'></div>");	
			document.write("<div onMouseOut='euEnv.euDockArray."+this.id+".mouseOut();' onMouseOver='euEnv.euDockArray."+this.id+".mouseOver();' id='"+this.id+"' style='z-index:0;position:absolute;border:0px solid black; cursor: pointer;'></div>");	
